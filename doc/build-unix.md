UNIX BUILD NOTES
====================
Some notes on how to build Tradercoin in Unix. 
...
This will build tradercoin-qt as well if the dependencies are met.
...
If you want to build Tradercoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a tradercoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip tradercoind" to strip the debug
