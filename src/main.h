...
static const int COINBASE_MATURITY = 6; //60; // 1 hour
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // tradercoin: 1440 blocks found a day. Priority cutoff is 100 tradercoin day / 250 bytes.
    }
 ...
 */
// tradercoin specific implementation, standardizes checks for the hard maturity change at block 145k
